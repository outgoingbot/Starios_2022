...
/*Izzle
 *Changes to this lib.
 *Changed from pagemode to horizontal mode addressing (allows DMA to be easier)
 *the ssd1306 has 8 pages but my oled has 32 cols, so only using 4 pages.
 *I need there to be 4 pages so the page counter on the ssd1306 goes back to page 0 after page 3
